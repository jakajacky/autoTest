...
@interface ASPopUpView () <CAAnimationDelegate>
@end
#endif
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLayer.foregroundColor = UIColorHex(32d250).CGColor;
        _textLayer.font = (__bridge CFTypeRef _Nullable)([UIFont systemFontOfSize:15]);
        _colorAnimLayer = [CAShapeLayer layer];
        
        self.layer.contents = (__bridge id _Nullable)([UIImage imageNamed:@"percent"].CGImage);
...
- (void)layoutSubviews
{
    ...
    CGRect textRect = CGRectMake(self.bounds.origin.x,
                                 (self.bounds.size.height-_arrowLength-textHeight)/2+3,
