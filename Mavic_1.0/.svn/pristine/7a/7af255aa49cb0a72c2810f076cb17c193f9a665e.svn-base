...
{
    Peripheral *L_T_Peripheral;
    Peripheral *L_B_Peripheral;
    Peripheral *R_T_Peripheral;
    Peripheral *R_B_Peripheral;
}
...
//    [self setBeginRefreshing];
    ...
    L_T_Peripheral = dm.L_T_Aid;
    L_B_Peripheral = dm.L_B_Aid;
    R_T_Peripheral = dm.R_T_Aid;
    R_B_Peripheral = dm.R_B_Aid;
...
- (void) didPeripheralFound:(CBPeripheral *)peripheral advertisementData:(BLEAdvertisementData *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    if ([peripheral.identifier.UUIDString isEqualToString:L_T_Peripheral.identifier]||[peripheral.identifier.UUIDString isEqualToString:L_B_Peripheral.identifier]||[peripheral.identifier.UUIDString isEqualToString:R_T_Peripheral.identifier]||[peripheral.identifier.UUIDString isEqualToString:R_B_Peripheral.identifier]) {
        return;
    }
...
- (void) didConnectPeripheral:(CBPeripheral *)peripheral {
    ...
    for (int i = 0; i < _listDataPeripheral.count; i++) {
        if ([_listDataPeripheral objectAtIndex:i] == peripheral) {
            ...
            mac = [peripheral.identifier.UUIDString componentsSeparatedByString:@"-"].firstObject;
